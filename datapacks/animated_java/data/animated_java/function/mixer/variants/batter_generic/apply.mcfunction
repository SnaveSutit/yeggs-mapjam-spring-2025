...
execute on passengers if entity @s[tag=aj.mixer.bone.malk] run function animated_java:mixer/variants/batter_generic/zzz/apply_to_bone_malk
...
execute on passengers if entity @s[tag=aj.mixer.bone.eggs_item] run function animated_java:mixer/variants/batter_generic/zzz/apply_to_bone_eggs_item
execute on passengers if entity @s[tag=aj.mixer.bone.berries] run function animated_java:mixer/variants/batter_generic/zzz/apply_to_bone_berries
execute on passengers if entity @s[tag=aj.mixer.bone.vanilla] run function animated_java:mixer/variants/batter_generic/zzz/apply_to_bone_vanilla
execute on passengers if entity @s[tag=aj.mixer.bone.chocolate] run function animated_java:mixer/variants/batter_generic/zzz/apply_to_bone_chocolate
return 1