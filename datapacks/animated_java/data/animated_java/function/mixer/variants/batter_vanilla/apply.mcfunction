...
execute on passengers if entity @s[tag=aj.mixer.bone.batter_output_plaque] run function animated_java:mixer/variants/batter_vanilla/zzz/apply_to_bone_batter_output_plaque
return 1