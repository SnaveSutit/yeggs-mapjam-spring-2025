...
execute on passengers if entity @s[tag=aj.frosting_mixer.bone.sugar_item] run function animated_java:frosting_mixer/variants/contents_strawberry/zzz/apply_to_bone_sugar_item
