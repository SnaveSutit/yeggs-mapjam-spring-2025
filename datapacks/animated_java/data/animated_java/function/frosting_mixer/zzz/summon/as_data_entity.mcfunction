...
summon minecraft:item_display ^-3 ^1 ^-3 {Tags:["aj.frosting_mixer.entity","aj.frosting_mixer.locator","aj.frosting_mixer.locator.milk_lock_point","aj.frosting_mixer.node","aj.frosting_mixer.node.milk_lock_point","aj.global.entity","aj.global.locator","aj.global.node","aj.global.node.milk_lock_point","aj.global.root.child","aj.global.root.child.locator","aj.new"]}
execute as @n[ type=minecraft:item_display, tag=aj.new, tag=aj.frosting_mixer.locator.milk_lock_point, distance=..5.358898943540674 ] run function animated_java:frosting_mixer/zzz/summon/as_data_entity/as_locator/milk_lock_point
