...
execute on vehicle on passengers if entity @s[tag=aj.pan.node.pan] run function animated_java:global/internal/gu/convert_uuid_array_to_string with entity @s
