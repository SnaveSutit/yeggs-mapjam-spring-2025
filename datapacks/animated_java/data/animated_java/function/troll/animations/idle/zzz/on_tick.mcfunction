...
execute if score @s aj.idle.frame matches -1 run function animated_java:troll/animations/idle/zzz/commands_keyframe_loop_patch
execute store result storage aj:temp frame int 1 run scoreboard players get @s aj.idle.frame
function animated_java:troll/animations/idle/zzz/apply_frame with storage aj:temp
